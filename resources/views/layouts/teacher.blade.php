            ...
            <nav class="mt-4 px-4 space-y-2 text-sm font-medium">
                <a href="/teacher/dashboard"
                    class="flex items-center gap-3 py-2.5 px-4 rounded-lg transition
                        {{ request()->is('teacher/dashboard') ? 'bg-purple-100 text-purple-700 font-semibold' : 'hover:bg-gray-100' }}">
                ...
                <a href="/teacher/classes"
                    class="flex items-center gap-3 py-2.5 px-4 rounded-lg transition
                        {{ request()->is('teacher/classes') ? 'bg-purple-100 text-purple-700 font-semibold' : 'hover:bg-gray-100' }}">
                ...
                <a href="/teacher/materials"
                    class="flex items-center gap-3 py-2.5 px-4 rounded-lg transition
                        {{ request()->is('teacher/materials') ? 'bg-purple-100 text-purple-700 font-semibold' : 'hover:bg-gray-100' }}">
                ...
                <a href="/teacher/quizzes"
                    class="flex items-center gap-3 py-2.5 px-4 rounded-lg transition
                        {{ request()->is('teacher/quizzes') ? 'bg-purple-100 text-purple-700 font-semibold' : 'hover:bg-gray-100' }}">
