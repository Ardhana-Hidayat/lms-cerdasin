@extends('layouts.teacher') {{-- Asumsi Anda punya layout guru --}}
        ...
        <div class="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-6">
            ...
            <div class="flex gap-3">
                ...
                <form action="#" method="POST"
                    ...
                    @method('DELETE')
                    <button type="submit"
                        class="inline-flex items-center gap-2 bg-red-100 text-red-500 px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-200 transition-all">
